...
//             <button type="button btn-danger" onClick={() => removeQuantityAndMrpField(index)}>
//               Remove
//             </button>
//           </div>
//         ))}

//         <button type="btn btn-primary button" onClick={addQuantityAndMrpField}>
//           Add Quantity and MRP
//         </button>
//         <div className="mb-3">
...
//     onChange={(e) => {
//     setSelectedCategory(e.target.value);
//     handleInputChange(e); // Call the existing handleInputChange function to update the product state
//   }}
//     className="form-control"
//     id="productCategory"
//     required
...
//     >
//       <option value="">Select a subcategory</option>
//       {/* Fetch and map subcategories based on the selected category */}
//       {categories
//         .find((category) => category.name === selectedCategory)
//         ?.subcategories.map((subcategory, index) => (
//           <option key={index} value={subcategory}>
